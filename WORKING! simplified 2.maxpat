...
, 			{
				"box" : 				{
					...
					"fontsize" : 11.595187,
					"id" : "obj-22",
					"items" : [ "IAC Driver Bus 1", ",", "IAC Driver IAC Bus 2", ",", "IAC Driver IAC Bus 3", ",", "IAC Driver IAC Bus 4", ",", "Network Session 1", ",", "CASIO USB-MIDI", ",", "Xkey37", ",", "X-Touch INT", ",", "X-Touch EXT", ",", "to Max 1", ",", "to Max 2" ],
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
