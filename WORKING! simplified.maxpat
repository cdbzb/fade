...
, 			{
				"box" : 				{
					...
					"fontsize" : 11.595187,
					"id" : "obj-22",
					"items" : [ "IAC Driver Bus 1", ",", "IAC Driver IAC Bus 2", ",", "IAC Driver IAC Bus 3", ",", "IAC Driver IAC Bus 4", ",", "Mackie Control", ",", "Breath Controller", ",", "CASIO USB-MIDI", ",", "Xkey37", ",", "to Max 1", ",", "to Max 2" ],
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 406.0, 465.0, 51.0, 22.0 ],
					"style" : "",
					"text" : "follow 0"
				}
